...
<p class="message">The <b>source</b> of a Jekyll build is the root directory containing the Jekyll directory structure. The <b>destination</b> of the Jekyll build is the <b>_site</b> directory. Jekyll takes all the configuration and post files from the <b>source</b> and translates them to a website at the <b>destination</b> directory.</p>
